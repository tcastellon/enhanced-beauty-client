...
import { useVisit, useUpdateVisit, useVisitServices } from "../hooks/useVisits";
        ...
        <div className="box">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field is-grouped">
                <button
                    type="submit"
                    className={`button is-primary ${updateVisit.isPending ? "is-loading": ""}`}
                    disabled={updateVisit.isPending}
                >
                    Update Visit
                </button>
                <Link to={`/visits?client=${visit?.client}`} className="button is-light">
                    Cancel
                </Link>
            </div>
          </form>
